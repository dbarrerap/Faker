...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = array(
        ...
        'Echevarría', 'Escalante', 'Escobar', 'Escobedo', 'Espinal', 'Espino', 'Espinosa', 'Espinoza', 'Esquibel', 'Esquivel', 'Estévez', 'Estrada',
        ...
        'Yáñez',
        'Zambrano', 'Zamora', 'Zamudio', 'Zapata', 'Zarate', 'Zavala', 'Zayas', 'Zelaya', 'Zepeda', 'Zúñiga'
    );

    protected static $titleMale = array('Sr.', 'Don', 'Dr.', 'Lic.', 'Ing.');
    ...
    /**
     * Generate a Cedula number
     *
     * @example '0912345678'
     *
     * @link https://www.jybaro.com/blog/cedula-de-identidad-ecuatoriana/
     */
